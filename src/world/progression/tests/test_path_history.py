...
class CharacterPathHistoryTest(TestCase):
    ...
    def test_create_path_history(self):
        ...
        self.assertEqual(history.character, self.sheet)
    ...
    def test_path_history_unique_constraint(self):
        ...
        CharacterPathHistory.objects.create(character=self.sheet, path=self.steel)
    ...
    def test_character_can_have_multiple_paths(self):
        ...
        CharacterPathHistory.objects.create(character=self.sheet, path=self.steel)
        CharacterPathHistory.objects.create(character=self.sheet, path=self.vanguard)

        self.assertEqual(self.sheet.path_history.count(), 2)
    ...
    def test_path_history_ordering(self):
        ...
        paths = list(self.sheet.path_history.all())
