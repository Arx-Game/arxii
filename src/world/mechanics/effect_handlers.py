...
def _legend_award(
    ...
    ``effective_risk`` comes from ``settled_risk_for_beat`` (#1770, #3463): the beat's
    ...
    if context.beat is not None and context.outcome_tier is not None:
        from world.stories.services.stakes import settled_risk_for_beat  # noqa: PLC0415

        risk_award = RISK_LEGEND_AWARDS[settled_risk_for_beat(context.beat)]
