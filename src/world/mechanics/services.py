...
def create_distinction_modifiers(
    ...
    for effect in distinction.effects.all():
        ...
        if effect.target.category.name == "resonance" and hasattr(effect.target, "resonance"):
            add_resonance_total(character, effect.target.resonance, value)
