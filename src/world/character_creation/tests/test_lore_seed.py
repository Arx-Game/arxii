...
class TestLoreOnboardingSeed(TestCase):
    ...
    def test_offers_chapter_keys_seed_cg_explanations(self):
        ...
        offers_chapter_keys = (
            ...
            "finaltouches_fears_heading",
            "finaltouches_enemy_reason_prompt",
            "finaltouches_enemy_reason_chip",
            "finaltouches_enemy_reason_offers_heading",
            "finaltouches_enemy_reason_offers_chip",
            ...
            "offers_word_spent",
            "offers_word_awards",
            "offers_word_see_more",
            "offers_word_held",
            "offers_chip_distinctions",
