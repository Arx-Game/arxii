...
guardian-reaction shape, extended in ADR-0156). `Situation.ENEMY_WINDUP_UNDERWAY` holds for its
...
events (#2638, ADR-0157): a `sends_flying` `ThreatPoolEntry`'s attack that lands damage
