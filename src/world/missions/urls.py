...
# NPC-mediated giving moved to /api/npc-services/roles/ +
# /api/npc-services/offers/?kind=MISSION per #686. Trigger-based givers
# (ROOM_TRIGGER + ENVIRONMENTAL_DETAIL) stayed on MissionGiver — #729.
