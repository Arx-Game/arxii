...
router.register(r"clue-details", ClueRevealOfferDetailsViewSet, basename="npc-clue-details")
...
router.register(r"lifecycle", NpcLifecycleViewSet, basename="npc-lifecycle")
