...
export function FinalTouchesStage({ draft, onRegisterBeforeLeave }: FinalTouchesStageProps) {
  ...
  return (
    <ChapterLeaf
      ...
      title={copy?.finaltouches_heading ?? STAGE_LABELS[Stage.FINAL_TOUCHES]}
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p
                  className={`text-2xl font-bold ${remainingPoints < 0 ? 'text-destructive' : ''}`}
                >
                  {remainingPoints}
                </p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-blue-800 dark:text-blue-200">
                ...
                <p>
                  Goals are optional but recommended. During play, you can invoke a goal when making
                  a check that relates to it. Your goal's point value adds as a bonus to the roll.
