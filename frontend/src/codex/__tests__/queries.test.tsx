      ...
      const mockEntries = [
        {
          ...
          subject_path: [
            { type: 'category' as const, id: 1, name: 'Magic' },
            { type: 'subject' as const, id: 2, name: 'Resonances' },
            { type: 'subject' as const, id: 3, name: 'Celestial' },
          ],
          display_order: 1,
      ...
      const mockEntries = [
        {
          ...
          subject_path: [
            { type: 'category' as const, id: 1, name: 'Magic' },
            { type: 'subject' as const, id: 2, name: 'Resonances' },
            { type: 'subject' as const, id: 5, name: 'Celestial' },
          ],
          display_order: 1,
          knowledge_status: null,
        },
