...
| **Sineating** | The action of the Sineater eating sins out of the Hollow. Sinner-initiated request; Sineater accepts via `PROMPT_PLAYER` `@reply` with chosen amount. |
