...
### The Damage Identity — Bounded Team-% Lane, Vow-Keyed Stacking, Smooth Execute (#2643, ADR-0155) [BUILT & WIRED]
...
(ADR-0155, the EQ2 lane guard).** A dedicated `mechanics.ModifierTarget` row named
