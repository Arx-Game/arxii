...
- **The Damage Identity — bounded percent lanes, vow-keyed stacking, execute (#2643,
  ADR-0157):** `combat.constants.ENEMY_LANE_CAP_PERCENT` (default 50) clamps the summed
  ...
  — see `docs/systems/magic.md`'s "The Damage Identity" section and ADR-0157 for the full
  composition.
