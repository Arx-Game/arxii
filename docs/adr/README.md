...
- [0241 — Selection is not presence, and the server is the mirror source](0241-selection-is-not-presence-and-the-server-is-the-mirror-source.md) (#3412 slice 1)
...
- [0243 - The Commonplace Book is the logged-in container idiom](0243-the-commonplace-book-is-the-logged-in-container-idiom.md) (#3412 slice 2; extends ADR-0227)
...
- [0192 — Gift lineage is a `Gift` self-FK, and it is PROTECTed rather than CASCADEd](0192-gift-lineage-is-a-gift-self-fk-protected-from-cascade.md) (#2891, prerequisite for #2764; related ADR-0050, ADR-0051, ADR-0071)
