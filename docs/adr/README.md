...
- [0278 - Rows a parent owns live behind a handler, not a prefetch](0278-cached-rows-live-behind-a-handler-not-a-prefetch.md) (#3673; extends ADR-0263, ADR-0008)
...
- [0293 - Reachability governs who can be addressed; the reply parent is the thread's anchor](0293-reachability-governs-addressing-not-audience-promotion.md) (#3787; decision 1 corrected #3811; related ADR-0170, ADR-0260, #3757, #3760)
...
- [0308 - A tie is two sides that pool one depth; labels carry awareness and history, never points](0308-a-tie-is-two-sides-that-pool-one-depth.md) (#3957; amends ADR-0117 and ADR-0109; related ADR-0024, ADR-0092, ADR-0110, ADR-0307)
