...
- **Stories system:** Beats with discriminator predicates, `BeatCompletion` audit, `BeatOutcome` (UNSATISFIED / SUCCESS / FAILURE / EXPIRED), `evaluate_auto_beats`, `record_gm_marked_outcome`, `record_aggregate_contribution`.
