...
- **Per-Resonance pull effect catalog for COVENANT_ROLE** — content authoring task, not a code slice. Tracked in **#751** (role-scoped powers), not Slice F.
