...
**Status: BUILT** (ADR-0157 — clones #1228's plummet pattern: marker + reactable
...
never races it — see ADR-0157 and `world.combat.sent_flying_content`'s module docstring.
