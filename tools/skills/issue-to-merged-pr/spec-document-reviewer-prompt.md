...
superpowers prompt with four additional review categories — contract
completeness, implied-condition robustness, external-constraint
conflicts, and walkthrough coverage (#3659) — tuned to address a calibration gap the canonical reviewer
